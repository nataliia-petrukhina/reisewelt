      ...
      <div className="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 md:gap-3 lg:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className="w-full p-2 rounded border search-bar-input bg-white border-gray-800"
            value={myCity}
        ...
        <div>
          ...
          <div className="w-full">
            <DatePicker
              ...
              className="w-full p-2  bg-white rounded border border-gray-500 cursor-pointer  search-bar-input"
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          <div
            className="w-full p-2 rounded border border-gray-800 pl-4 bg-white cursor-pointer search-bar-input"
